...
The KNN classification script is straightforward. The script can simply be run as follows:
```bash
python knn.py --dataset <dataset_name> --model mae-lightning-small --weights MAE_SMALL_STED
```
