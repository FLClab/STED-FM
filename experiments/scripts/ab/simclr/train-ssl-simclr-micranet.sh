...
python main.py --seed 42 --use-tensorboard --dataset-path "${SLURM_TMPDIR}/dataset.tar" --backbone "micranet" --restore-from "/scratch/anbil106/anbil106/SSL/baselines/micranet/result.pt"
