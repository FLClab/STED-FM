...
python knn_v2.py --dataset optim --model resnet18 --weights RESNET18_SSL_STED_ABLATION
...
python knn_v2.py --dataset neural-activity-states --model resnet18 --weights RESNET18_SSL_STED_ABLATION
...
python knn_v2.py --dataset peroxisome --model resnet18 --weights RESNET18_SSL_STED_ABLATION
...
# python knn_v2.py --dataset polymer-rings --model micranet --weights MICRANET_SSL_HPA
# python knn_v2.py --dataset polymer-rings --model micranet --weights MICRANET_SSL_STED

# python knn_v2.py --dataset polymer-rings --model resnet18 --weights RESNET18_IMAGENET1K_V1
# python knn_v2.py --dataset polymer-rings --model resnet18 --weights RESNET18_SSL_HPA
python knn_v2.py --dataset polymer-rings --model resnet18 --weights RESNET18_SSL_STED
python knn_v2.py --dataset polymer-rings --model resnet18 --weights RESNET18_SSL_STED_ABLATION

# python knn_v2.py --dataset polymer-rings --model resnet50 --weights RESNET50_IMAGENET1K_V1
# python knn_v2.py --dataset polymer-rings --model resnet50 --weights RESNET50_SSL_HPA
# python knn_v2.py --dataset polymer-rings --model resnet50 --weights RESNET50_SSL_STED

# python knn_v2.py --dataset polymer-rings --model convnext-tiny --weights CONVNEXT_TINY_IMAGENET1K_V1
# python knn_v2.py --dataset polymer-rings --model convnext-tiny --weights CONVNEXT_TINY_SSL_STED

# python knn_v2.py --dataset polymer-rings --model convnext-small --weights CONVNEXT_SMALL_IMAGENET1K_V1
# python knn_v2.py --dataset polymer-rings --model convnext-small --weights CONVNEXT_SMALL_SSL_STED

# python knn_v2.py --dataset polymer-rings --model convnext-base --weights CONVNEXT_BASE_IMAGENET1K_V1
# python knn_v2.py --dataset polymer-rings --model convnext-base --weights CONVNEXT_BASE_SSL_STED

# python knn_v2.py --dataset polymer-rings --model convnext-large --weights CONVNEXT_LARGE_IMAGENET1K_V1
# python knn_v2.py --dataset polymer-rings --model convnext-large --weights CONVNEXT_LARGE_SSL_STED
