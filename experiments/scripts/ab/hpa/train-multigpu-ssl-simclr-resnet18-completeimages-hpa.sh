...
cp "/project/def-flavielc/datasets/train.zip" "${SLURM_TMPDIR}/dataset.zip"
...
tensorboard --logdir="/scratch/anbil106/anbil106/SSL/baselines/dataset-fullimages-1Msteps-multigpu/resnet18_hpa" --host 0.0.0.0 --load_fast false &
srun python main-lightning.py --seed 42 --use-tensorboard --dataset-path "${SLURM_TMPDIR}/dataset.zip" --backbone "resnet18" --dataset "hpa" \
							  --save-folder "./data/SSL/baselines/dataset-fullimages-1Msteps-multigpu" \
							  --restore-from "/scratch/anbil106/anbil106/SSL/baselines/dataset-fullimages-1Msteps-multigpu/resnet18_hpa/result.pt"
