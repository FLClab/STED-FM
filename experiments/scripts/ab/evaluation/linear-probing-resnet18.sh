...
python finetune_v2.py --dataset $dataset --model resnet18 --weights RESNET18_IMAGENET1K_V1 --seed $seed
python finetune_v2.py --dataset $dataset --model resnet18 --weights RESNET18_SSL_HPA --seed $seed
python finetune_v2.py --dataset $dataset --model resnet18 --weights RESNET18_SSL_JUMP --seed $seed
python finetune_v2.py --dataset $dataset --model resnet18 --weights RESNET18_SSL_STED --seed $seed
