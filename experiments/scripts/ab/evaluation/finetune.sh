...
# python finetune_v2.py --dataset synaptic-proteins --model micranet --weights MICRANET_SSL_HPA --blocks 0
# python finetune_v2.py --dataset synaptic-proteins --model micranet --weights MICRANET_SSL_STED --blocks 0

# python finetune_v2.py --dataset synaptic-proteins --model resnet18 --weights RESNET18_IMAGENET1K_V1 --blocks 0
# python finetune_v2.py --dataset synaptic-proteins --model resnet18 --weights RESNET18_SSL_HPA --blocks 0
# python finetune_v2.py --dataset synaptic-proteins --model resnet18 --weights RESNET18_SSL_STED --blocks 0

# python finetune_v2.py --dataset synaptic-proteins --model resnet50 --weights RESNET50_IMAGENET1K_V1 --blocks 0
# python finetune_v2.py --dataset synaptic-proteins --model resnet50 --weights RESNET50_SSL_HPA --blocks 0
# python finetune_v2.py --dataset synaptic-proteins --model resnet50 --weights RESNET50_SSL_STED --blocks 0

# python finetune_v2.py --dataset synaptic-proteins --model convnext-tiny --weights CONVNEXT_TINY_IMAGENET1K_V1 --blocks 0
# python finetune_v2.py --dataset synaptic-proteins --model convnext-tiny --weights CONVNEXT_TINY_SSL_STED --blocks 0

# python finetune_v2.py --dataset synaptic-proteins --model convnext-small --weights CONVNEXT_SMALL_IMAGENET1K_V1 --blocks 0
# python finetune_v2.py --dataset synaptic-proteins --model convnext-small --weights CONVNEXT_SMALL_SSL_STED --blocks 0

# python finetune_v2.py --dataset synaptic-proteins --model convnext-base --weights CONVNEXT_BASE_IMAGENET1K_V1 --blocks 0
# python finetune_v2.py --dataset synaptic-proteins --model convnext-base --weights CONVNEXT_BASE_SSL_STED --blocks 0

# python finetune_v2.py --dataset synaptic-proteins --model convnext-large --weights CONVNEXT_LARGE_IMAGENET1K_V1 --blocks 0
# python finetune_v2.py --dataset synaptic-proteins --model convnext-large --weights CONVNEXT_LARGE_SSL_STED --blocks 0

# python finetune_v2.py --dataset synaptic-proteins --model mae-lightning-tiny --weights MAE_TINY_IMAGENET1K_V1 --blocks 0
# python finetune_v2.py --dataset synaptic-proteins --model mae-lightning-tiny --weights MAE_TINY_JUMP --blocks 0
# python finetune_v2.py --dataset synaptic-proteins --model mae-lightning-tiny --weights MAE_TINY_STED --blocks 0

# python finetune_v2.py --dataset synaptic-proteins --model mae-lightning-small --weights MAE_SMALL_IMAGENET1K_V1 --blocks 0
# python finetune_v2.py --dataset synaptic-proteins --model mae-lightning-small --weights MAE_SMALL_JUMP --blocks 0
# python finetune_v2.py --dataset synaptic-proteins --model mae-lightning-small --weights MAE_SMALL_STED --blocks 0

# python finetune_v2.py --dataset synaptic-proteins --model mae-lightning-base --weights MAE_BASE_IMAGENET1K_V1 --blocks 0
# python finetune_v2.py --dataset synaptic-proteins --model mae-lightning-base --weights MAE_BASE_JUMP --blocks 0
# python finetune_v2.py --dataset synaptic-proteins --model mae-lightning-base --weights MAE_BASE_STED --blocks 0

# python finetune_v2.py --dataset synaptic-proteins --model mae-lightning-large --weights MAE_LARGE_IMAGENET1K_V1 --blocks 0
# python finetune_v2.py --dataset synaptic-proteins --model mae-lightning-large --weights MAE_LARGE_JUMP --blocks 0
# python finetune_v2.py --dataset synaptic-proteins --model mae-lightning-large --weights MAE_LARGE_STED --blocks 0
