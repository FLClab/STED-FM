...
def get_pretrained_model_v2(name: str, weights: str = None, as_classifier: bool = False, **kwargs):
    ...
    :returns : A `torch.nn.Module` model and its `Configuration`
    """
    if name in ["resnet18", "resnet50", "resnet101", "micranet", "convnext-tiny", "convnext-small", "convnext-base", "vit-small", "mae-lightning-tiny", "mae-lightning-small", "mae-mcms-lightning-small", "mae-mcms-token-lightning-small", 'mae-lightning-base', 'mae-lightning-large', 'mae-lightning-64-p8', "mae-lightning-224-p16"]:
